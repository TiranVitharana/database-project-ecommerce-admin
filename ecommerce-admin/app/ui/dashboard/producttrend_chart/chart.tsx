...
const ProductTrend = () => {
  ...
  return (
    <div className="bg-backgroundSoft p-5 rounded-lg">
      <h1 className="text-2xl font-bold mt-10">Product trends over time</h1>
  ...
  <h3 className="text mt-5">
    {selectedProduct ? (<>Showing results for <span className="font-bold">{selectedProduct}</span></>) : ('Please select a product')}
  </h3>
